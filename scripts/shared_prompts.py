...
Begin the output paragraph by stating the shot framing and camera angle (e.g., "A low-angle full-body shot...", "A 3/4-angle medium shot from the left...", "A straight-on close-up..."). This ensures the angle is clearly captured for image generation.
...
输出段落必须以景别和拍摄角度开头（例如："仰拍全身构图，……"、"四分之三左侧角近景……"、"正面特写……"），确保拍摄角度在提示词中突出呈现。
...
WARMUP_EN = (
    ...
    "Always BEGIN the paragraph by stating the shot framing and exact camera angle "
    "(e.g., 'A low-angle full-body shot...', 'A 3/4-angle medium shot from the left...'). "
...
WARMUP_ZH = (
    ...
    "- 若无人物则完全省略人物描述。\n\n"
    "输出格式：单段流畅自然的中文，150至400字，"
    "段落必须以景别和拍摄角度开头（例如：仰拍全身构图……、四分之三左侧角近景……）。"
    "直接输出提示词，不加任何前言或说明。\n\n"
    "确认理解请回复：准备就绪"
)
